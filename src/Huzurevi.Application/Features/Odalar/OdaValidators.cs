...
internal static class OdaKurallari
{
    ...
    public static readonly string[] Ozellikler =
        ["Klima", "Banyo", "Tuvalet", "Balkon", "Engelli erişim", "Oksijen hattı", "Acil çağrı"];
}
...
public class OdaOlusturIstekDogrulayici : AbstractValidator<OdaOlusturIstek>
{
    public OdaOlusturIstekDogrulayici()
    {
        ...
        RuleFor(x => x.Ozellikler)
            .Must(v => v is null || v.All(o => OdaKurallari.Ozellikler.Contains(o)))
            .WithMessage("Oda özelliği geçersiz.");
    }
}
